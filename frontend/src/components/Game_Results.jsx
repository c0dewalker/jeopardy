...
import { startNewGameAC, initializeNewGameAC, setIsPlayingTrueAC } from '../store/actions'
  ...
  return (
    <div className="modal-overlay">
      <div className="modal" >
          ...
          <h4>Your score is:</h4>
          <h2>{score}</h2>
          <Button type="primary" size="large" style={style} onClick={startNewGameHandler}>Start new game</Button>
          <Button type="primary" size="large" style={style} onClick={cancelHandler}>Cancel</Button>
      </div>
    </div>
  )
}
